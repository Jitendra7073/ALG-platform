...
async function runMigrations() {
  ...
  try {
    ...
    try {
      ...
      await client.query(`CREATE INDEX IF NOT EXISTS idx_sites_country ON sites(country);`);
      ...
      await client.query(`CREATE INDEX IF NOT EXISTS idx_email_queue_country_code ON email_queue(country_code);`);
    } catch(e) {
