...
async function runMigration() {
  ...
  try {
    ...
    // Create indexes
    await client.query(`CREATE INDEX idx_country_timezones_country_code ON country_timezones(country_code);`);
    await client.query(`CREATE INDEX idx_country_timezones_region ON country_timezones(region);`);
    ...
    console.log(`✅ country_timezones table created successfully with ${result.rows.length} countries.`);
    process.exit(0);
  } catch (error) {
